                        ...
                        <form method="POST" action="{{ route('article.store') }}">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-7">
                                    <input id="title" type="text"
                                        ...
                                        value="{{ old('title') }}" required autocomplete="title" placeholder="Title"
                                        autofocus>
                                    @error('title')
                            ...
                            <div class="form-group row">
                                <label for="description"
                                    class="col-md-3 col-form-label text-md-right">{{ __('Body') }}</label>
                                <div class="col-md-7">
                            ...
                            <div class="form-group row">
                                <label for="published"
                                    class="col-md-3 col-form-label text-md-right">{{ __('Published') }}</label>
                                <div class="col-md-7">
                                    <select name="published" id="published"
                                        class="form-control @error('published') is-invalid @enderror">
                                        <option value="0" {{ old('published') == 0 ? 'selected' : '' }}>Unpublished
                                        </option>
                                        <option value="1" {{ old('published') == 1 ? 'selected' : '' }}>Published
                                        </option>
                                    </select>
                                    @error('published')
                                        <span class="invalid-feedback" role="alert">
